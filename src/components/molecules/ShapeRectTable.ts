...
export interface ShapeRectTableConfig extends ShapeLocationGroupConfig {
  minWidth: number;
  minHeight: number;
}
 ...
 * 四角テーブル
 */
export class ShapeRectTable extends ShapeLocationGroup<ShapeRectTableConfig> {
  private OFFSET_X = 2;
  private OFFSET_Y = 2;
   ...
   * 初期化します.
   */
  constructor(config: ShapeRectTableConfig) {
    super(config);
